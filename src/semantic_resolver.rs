...
mod incremental_tests {
    ...
    fn incremental_repair_names_the_validator_failure_and_conflict_shape() {
        ...
        assert!(instructions.contains("A withdraw operation uses an empty key and text"));
