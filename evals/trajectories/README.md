...
|---|---|---|---|
| Codex development agent | `SPEC.md`, operator steering | `development-recovery.sanitized.jsonl` | Reconstructed development record tied to commits and test output |
